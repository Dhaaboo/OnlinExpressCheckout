...
public class NVPAPICaller
{
    ...
    public string APIUsername = "xarwaashe00-facilitator_api1.yahoo.com";
    private string APIPassword = "QA78QEM84ZKN26TE";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AbDRrkkkuTKlSgeFZs2QXJkmim0B";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44320/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44320/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "DevTest";
        ...
        using (OnlinExpressCheckout.Logic.ShoppingCartActions myCartOrders = new OnlinExpressCheckout.Logic.ShoppingCartActions())
        {
